<div class="contePro"></div>
        ...
        <div class="lineTwoProducts"></div>
        <div class="textOneProducts">
            <h3>Este producto nació para proteger tú<br> 
                vida y la de aquellos que más amas,<br>  
