...
class email {
   ...
   public function sendEmail($email, $bondId, $url, $type, $subject){
...
try {
    ...
    $mail->Username   = 'soporthelmytwo@gmail.com';                     // SMTP username
    $mail->Password   = 'solerandres321';                               // SMTP password
    $mail->SMTPSecure = 'tls';                                  // Enable TLS encryption, `ssl` also accepted
    $mail->Port       = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('soporthelmytwo@gmail.com', 'Helmy');
                          ...
                          >
                            <tr>
                              ...
                              >
                                ...
                                ></p>
                                <p>
                                  Tu moto se registro en un contrato inteligente con este ID de enlace: '.$bondId.' , para verificar visite el sitio presionando este boton he ingrese el ID de enlace.
                                </p>
                                <table
                                  role="presentation"
                                  border="0"
                                    ...
                                    <tr>
                                      <td>
                                        <p
                                          style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"
                                        >
                                        Si eso no funciona, copia y pega el siguiente enlace en tu navegador.
                                          <a
                                            >'.$url.'</a
                                          >
                                        </p>
                          ...
                          >
                            <tr>
                              ...
                              >
                                ...
                                ></p>
                                <p>
                                   Tu moto se elimino identificada con este ID de enlace: '.$bondId.', para verificar visite el sitio presionando este boton he ingrese el ID de enlace.
                                </p>
                                <table
                                  role="presentation"
                                  border="0"
